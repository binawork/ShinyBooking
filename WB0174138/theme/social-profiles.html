         ...
         <div class="container">
            <div class="row">
               <div class="col-md-12 text-center">
                  <h1 class="mt-0 mb-3 text-white">Social Profiles</h1>
                  <div class="breadcrumbs">
                     <p class="mb-0 text-white"><a class="text-white" href="#">Home</a>  /  <span class="text-success">Social Profiles</span></p>
                  </div>
               </div>
            </div>
         </div>
            ...
            <div class="row">
               <div class="col-lg-12">
                  <ul class="nav justify-content-center">
                     ...
                     <li class="nav-item">
                        <a class="nav-link active text-success" href="social-profiles.html">Social Profiles</a>
                     </li>
                     <li class="nav-item">
