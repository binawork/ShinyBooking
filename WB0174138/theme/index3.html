                     ...
                     <div class="container banner-list pl-5 pr-5">
                        <div class="row">
                           <div class="col-lg-8 col-md-8">
                              <h1 class="mt-5 mb-4 text-white">Find Your Favorite Property</h1>
                              <h6 class="mb-5 text-white">Vivamus luctus egestas convallis. Vestibulum arcu sapien,<br> consequat a urna a, gravida molestie est. Mauris iaculis felis id elit laoreet,<br> vitae blandit odio lacinia. Etiam viverra arcu lobortis semper posuere. Curabitur mattis a erat at ultricies. Duis ac porta est</h6>
                              <button class="btn btn-success" type="button">Contact Us</button>
                              <button class="btn btn-outline-success" type="button">Read More</button>
                           </div>
