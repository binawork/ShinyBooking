            ...
            <div class="row">
               <div class="col-md-12 text-center">
                  ...
                  <div class="breadcrumbs">
                     <p class="mb-0 text-white"><a class="text-white" href="#">Home</a>  /  <span class="text-success">My Properties</span></p>
                  </div>
               </div>
            </div>
         </div>
            ...
            <div class="row">
               <div class="col-lg-12">
                  <ul class="nav justify-content-center">
                     ...
                     <li class="nav-item">
                        <a class="nav-link active text-success" href="my-properties.html">My Properties</a>
                     </li>
                     <li class="nav-item">
